/*
 * ml-plugin: datasets-projectAdmin.js
...
/*!
 * Site-wide Admin UI functions for dataset definitions and collections
 */

console.log('datasets-projectAdmin.js');
...
(function(factory){
    ...
    XNAT.plugin.datasets.projDatasets = projDatasets =
        getObject(XNAT.plugin.datasets.projDatasets || {});
        ...
        XNAT.xhr.getJSON({
            ...
            success: function(data){
                if (data.length) {
                    ...
                    XNAT.plugin.datasets.projDatasets.savedDatasets = data;
    ...
    $(document).on('click','.view-dataset',function(e){
        ...
        XNAT.xhr.getJSON({
            ...
            success: function(data){
                XNAT.plugin.datasets.projDatasets.viewDataset(data);
            }
        })
    });
            ...
            okAction: function () {
                XNAT.xhr.ajax({
                    ...
                    success: function () {
                        ...
                        XNAT.plugin.datasets.projDatasets.init();
                    }
                })
            }
        });
