/*
 * ml-plugin: create-collection.js
...
(function(factory){
    ...
    XNAT.plugin.datasets.availableExpts = [];
    ...
    XNAT.plugin.datasets.getProjectExperiments = function(project){
        XNAT.xhr.getJSON({
            ...
            success: function(data){
                XNAT.plugin.datasets.availableExpts = data.ResultSet.Result;
            }
        })
    };
    ...
    $(document).ready(function(){
        XNAT.plugin.datasets.getProjectExperiments(projectId);
    });
    ...
    XNAT.plugin.datasets.collectionCreator = collectionCreator =
        getObject(XNAT.plugin.datasets.collectionCreator || {});
        ...
        XNAT.dialog.open({
            ...
            beforeShow: function(obj){
                ...
                inputArea.append(spawn('!',[
                    spawn('div.message',{ style: { 'margin-bottom': '1em' }},'Select the experiments you want to include in this dataset collection. XNAT will randomly sort your selected experiments into a 70/20/10 Train/Validation/Test format.'),
                ...
                var sortedExperiments = sortByXsiType(XNAT.plugin.datasets.availableExpts);
                    ...
                    action: function(obj){
                        ...
                        XNAT.xhr.ajax({
                            ...
                            success: function(data){
                                ...
                                console.log(data);
                                XNAT.plugin.datasets.projCollections.refresh(true);
    ...
    collectionCreator.open = function(xsitype){
        var expts = XNAT.plugin.datasets.availableExpts;
        if (xsitype) {
