/*
 * ml-plugin: org.nrg.xnatx.plugins.datasets.services.DatasetDefinitionService
...
import org.nrg.xnatx.plugins.datasets.resolvers.ResolutionReport;
...
public interface DatasetDefinitionService extends DatasetObjectService<SetsDefinition> {
    /**
     * Resolves the specified definition into the returned collection. Note that this method
     ...
     *
     * @return The resolved {@link SetsCollection dataset collection}.
     */
    ...
    /**
     * Resolves the specified definition into the returned collection.  This method combines the
     ...
     *
     * @return The resolved and saved {@link SetsCollection dataset collection}.
     */
    ...
    /**
     * Resolves the submitted definition into the returned collection. Note that this method
     * returns an initialized instance of the {@link SetsCollection} class, but the instance is not
